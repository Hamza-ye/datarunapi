...
> **Current step:** Step 1 ✅ (Maven scaffold + boundary enforcement)
> **Next step:** Step 2 — Core module: Entity + EntityType + Event
...
|------|------|-----------|
| 2 | Core module: Entity + EntityType + Event | Step 1 ✅ |
